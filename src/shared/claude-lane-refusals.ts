...
export const CLAUDE_LANE_REFUSAL_CODES = [
  ...
  // S9-L2 (design rev 38 §3, row 1/2/9): the fifteen minted refusals of the login quartet plus
  // selectAccount/removeAccount/logout. Every one carries a complete sentence (below) because the
  // client has no string table for these.
