...
import { assertCaptureSourceOutsideClaudeGrants } from '../claude-accounts/managed-capture-containment'
...
export class CodexAccountService {
  ...
  private importCodexAuthFromHome(
    ...
    assertCaptureSourceOutsideClaudeGrants(trimmed, 'codex-home')
