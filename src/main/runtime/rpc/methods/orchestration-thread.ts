...
import { normalizeThreadSinceTimestamp } from '../../orchestration/thread-replay-since-filter'
  ...
  defineMethod({
    ...
    handler: (params, { runtime }) => {
      ...
      const messages = db.getThreadMessages(
        params.id,
        params.since !== undefined ? normalizeThreadSinceTimestamp(params.since) : undefined
      )
