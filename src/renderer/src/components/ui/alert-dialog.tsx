...
function AlertDialogOverlay({
  ...
  return (
    <AlertDialogPrimitive.Overlay
      ...
      // Matches Dialog's scrim recipe (dialog.tsx) — a flat 50% black scrim disappears into a
      // near-black dark canvas, so a deeper scrim + blur lifts it instead.
      className={cn(
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        // Matches Dialog's translucent-surface recipe (dialog.tsx) for both themes.
        className={cn(
